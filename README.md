...
GDP data: link to World Bank GDP data for Germany: https://data.worldbank.org/indicator/NY.GDP.MKTP.CD?locations=DE
...
Convert the data into numerical format (e.g., convert "200,000" to 200000).
...
Ensure that the inflation rate data is in the same timeframe as the GDP data.
